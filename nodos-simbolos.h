...
class NodoDeclaracionFunc: public NodoDeclaracion
{
	...
	NodoDeclaracionFunc(string tipoRetorno,string nombreFuncion,
                     parametrosFuncion* parametros,bloqueInstrucciones* codigo, ListaSimbolos *listaSimbolos):
        tipoRetorno(tipoRetorno),nombreFuncion(nombreFuncion),parametros(parametros),codigo(codigo){
            listaSimbolos->insertarNuevo(nombreFuncion, "t_id", "");
        }

	NodoDeclaracionFunc(string tipoRetorno,string nombreFuncion,bloqueInstrucciones* codigo, ListaSimbolos *listaSimbolos):
...
class NodoDeclaracionVar: public NodoDeclaracion
{
	...
	string tipoVar;
	listaVar* variables;
	NodoDeclaracionVar(string tipoVar,listaVar* variables, ListaSimbolos *listaSimbolos):
	    tipoVar(tipoVar), variables(variables){
            listaSimbolos->insertarNuevo(variables.back(), tipoVar, "");
        }
